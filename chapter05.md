...
|----------------------------|------------------------|-----------------------------------------------------------------------|------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| **Materials**       | POST, GET              | POST: `/api/v1/materials`, GET: `/api/v1/materials/{materialId}`                                                                                                    | GET: `"id": int`, POST: `"name": "string", "quantity": int, "quantityStatus": "string", "provider": "string"`                                                                                                                                                                                             | -                 | En este caso, se está devolviendo el valor de todos los objetos "materials" alojados en el JSON con el nombre `api/v1/materials`.                   |
| **Products**        | POST, GET              | POST: `/api/v1/products`, GET: `/api/v1/products/{productId}`                                                                                                       | GET: `"id": int`, POST: `"name": "string", "materials": [{"id": int, "name": "string"}], "employee": {"id": int, "name": "string"}`                                                                                                                                                                    | -                 | En este caso, se está devolviendo el valor de todos los objetos "products" alojados en el JSON con el nombre `api/v1/products`.                    |
